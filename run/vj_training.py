...
if __name__ == '__main__':
    ...
    model = VjVae(visual_model=visual_vae, auditive_model=music_vae, learning_rate=1e-3)
    model.build()
    ...
    # load data
    train_iterator, valid_iterator = dataset.get_train_audio_iterators(batch_size=args.batch_size)
